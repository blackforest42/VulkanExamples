  ...
  */
  void loadTexture() {
    ...
    if (useStaging) {
      ...
      vkCmdCopyBufferToImage(copyCmd, stagingBuffer, texture_.image,
    ...
    sampler.maxLod = (useStaging) ? (float)texture_.mipLevels : 0.0f;
    ...
    view.subresourceRange.levelCount = (useStaging) ? texture_.mipLevels : 1;
  ...
  void setupDescriptors() {
    ...
    // e.g.shader read)
    textureDescriptor.imageLayout = texture_.imageLayout;
